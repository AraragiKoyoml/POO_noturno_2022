 ...
 * @author Fatec
 */
@WebServlet(name = "MoisesJurosCompostoServlet", urlPatterns = {"/MoisesJurosComposto.json"})
public class MoisesJurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet MoisesJurosCompostoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            file.put(jur, j);
            double x = 1+(j/100);
            double somJur =(c*Math.pow(x,m));
            out.println("<h2>Capital: "+c+"</h2>");
            out.println("<h2>Juros: "+j+"</h2>");
            out.println("<h2>Meses: "+m+"</h2>");
            
            
            out.println("<h2>Valor Total a Pagar:  "+(decim.format((somJur)))+" </h2>");
            out.println("<h2>Juros "+(decim.format((somJur -c)))+" </h2>");
